    ...
    if(total == 0){
        ...
        for(int i=0;i<total;i++){
            if(rollNo == students[i].rollNumber){
                ...
                cout<<"Roll Number: ";cin>>students[i].rollNumber;
                cout<<"Course: ";cin>>students[i].course;
                cout<<"Class Section: ";cin>>students[i].className;
            ...
            for(int i=0;i<total;i++){
                if(rollNum == students[i].rollNumber){
                    for(int j=i;j<total;j++){
                        ...
                        students[j].className = students[j+1].className;
                        students[j].contact = students[j+1].contact;
                    }
                    total--;
